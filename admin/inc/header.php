...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?php echo $url_web ?>/<?php echo !empty($sesi['foto_admin']) ? 'foto_admin/'.$sesi['foto_admin'] : 'dist/img/user2-160x160.jpg'; ?>?t=<?php echo time(); ?>" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <li class="nav-item">
          <a href="beranda" class="nav-link"><i class="nav-icon fas fa-home"></i><p>Beranda</p></a>
        </li>
        <li class="nav-item">
          <a href="user?page=data" class="nav-link"><i class="nav-icon fas fa-user"></i><p>User</p></a>
        </li>
        <li class="nav-item">
          <a href="layanan?page=data" class="nav-link"><i class="nav-icon fas fa-columns"></i><p>Layanan</p></a>
        </li>
        <li class="nav-item">
          <a href="bank?page=data" class="nav-link"><i class="nav-icon fas fa-book"></i><p>Bank</p></a>
        </li>
        <li class="nav-item">
          <a href="pemesanan?page=data" class="nav-link"><i class="fas fa-cart-plus fa-lg mr-2"></i><p>Pemesanan</p></a>
        </li>
        <li class="nav-item">
          <a href="bantuan?page=data" class="nav-link"><i class="nav-icon fas fa-copy"></i><p>Tiket Bantuan</p></a>
        </li>
        <li class="nav-item">
          <a href="pengaturan" class="nav-link"><i class="fas fa-laptop"></i><p>Pengaturan</p></a>
        </li>
        <li class="nav-item">
          <a href="logout" class="nav-link"><i class="nav-icon fas fa-home"></i><p>Logout</p></a>
        </li>
      </ul>
    </nav>
  </div>
