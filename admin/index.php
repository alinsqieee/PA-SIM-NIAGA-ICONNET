  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        ...
        <a href="<?php echo $url_web ?>/admin/" class="h2"><b><?php echo $aplikasi ?></b></a>
      </div>
      <div class="card-body">
        ...
        if (isset($_POST['login'])) {
          ...
          $query   = mysqli_query($koneksi, "SELECT * FROM tadmin WHERE pass_admin='$password' AND email_admin='$username'");
